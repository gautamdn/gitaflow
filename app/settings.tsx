        ...
        <View style={[styles.section, { backgroundColor: colors.surface }]}>
          <View style={styles.apiKeySection}>
            <Text style={[styles.apiKeyHint, { color: colors.textSecondary }]}>
              Audio and pronunciation features work out of the box (30 listens, 10 recordings per day). For unlimited access, add your own Sarvam AI key from dashboard.sarvam.ai
            </Text>
            <TextInput
              value={apiKey}
              onChangeText={(text) => {
        ...
        <View style={[styles.section, { backgroundColor: colors.surface }]}>
          <View style={[styles.settingRow, { borderBottomWidth: 0, flexDirection: 'column', alignItems: 'stretch' }]}>
            ...
            <Text style={[styles.apiKeyHint, { color: colors.textSecondary, marginTop: SPACING.sm, marginBottom: 0 }]}>
              Gita Chant asks for your permission before sending any text or audio to Sarvam AI. The next time you tap Listen or Record, you will be asked again.
            </Text>
            {sarvamConsentGranted && (
              <Pressable
